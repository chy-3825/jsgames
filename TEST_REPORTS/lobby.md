...
| 门禁 | 当前结果 | 说明 |
| --- | --- | --- |
| `npm test` | 511/511 通过 | 已编写的单元、协议、规则、前端契约、架构边界和实时安全策略全部通过；不等同于 28 款游戏全部官方规则 1:1 签署 |
...
- 架构与实时安全回归、全量 `npm test` 均为 **511/511**；Firefox **28/28 模块、96/96 视觉夹具**和 Chromium **28/28 模块、72/72 视觉夹具**均通过。
