const GuessNumberEngine = require('./engine');

const metadata = { type: 'guessnumber', name: '猜数字', minPlayers: 1, maxPlayers: 1 };
...
module.exports = {
    ...
    create(roomId, players, hostId, options = {}) {
        ...
        return new GuessNumberSession(roomId, players, resolvedOptions);
    },
};
