export function createDecryptoTemplate() {
    return `
        <section class="decrypto-app">
            ...
            <div class="dc-scene-transition is-hidden" data-role="sceneTransition" role="status" aria-live="assertive" aria-atomic="true" aria-hidden="true"><div><small data-role="sceneKicker"></small><strong data-role="sceneTitle"></strong><span data-role="sceneDetail"></span><button type="button" class="dc-scene-skip" data-action="skip-scene">跳过视觉动画</button></div></div>
