...
export function createGameClient({ mount, send, addLog }) {
    ...
    let state = null; let previous = new Map(); let selected = null; let perspectiveColor = null; let viewMode = isCompactPointer && localStorage.getItem(explicitViewModeStorageKey) !== '1' ? '2d' : savedViewMode === '2d' ? '2d' : '3d'; let yaw = 0; let pitch = .75; let distance = 17; let dragging = false; let dragId = null; let lastPointer = { x: 0, y: 0 }; let frame = null; let renderUntil = 0; let destroyed = false; let graphicsFailed = false; const resizeTimers = [];
