    ...
    return `<section class="sp-app">
        ...
        <main class="sp-layout">
            <section class="sp-market-stage">
                ...
                <div class="sp-quick-summary" data-role="quickSummary" aria-label="我的商会摘要"></div>
                <nav class="sp-tier-tabs" data-role="tierTabs" aria-label="选择发展卡等级" role="tablist"></nav>
