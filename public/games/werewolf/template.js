...
export function createWerewolfTemplate() {
    return `
        <section class="ww-app">
            ...
            <main class="ww-layout">
                ...
                <section class="ww-screen">
                    ...
                    <section class="ww-flow" aria-live="polite">
                        <div class="ww-flow-stage is-current"><small>此刻</small><div class="ww-flow-current"><strong data-role="currentPhase">静候开局</strong><span class="ww-night-clock is-hidden" data-role="nightClock"><em>夜间剩余</em><b data-role="nightRemaining">20s</b></span></div></div>
                    ...
                    <div class="ww-screen-body">
                        ...
                        <aside class="ww-screen-side">
                            ...
                            <section class="ww-auto-note"><strong>无需主持人</strong><p>夜间每个角色固定行动 20 秒；提前完成也会等待倒计时结束，超时默认不发动技能。</p></section>
                        </aside>
                    </div>
            ...
            <div class="ww-overlay is-hidden" data-role="rules"><article><button data-ui="closeRules" type="button">×</button><small>本局约定</small><h2>开始前请知晓</h2><ol><li>9 人局为 3 狼、3 神（预言家、女巫、猎人）、3 民；12 人局为 4 狼、4 神（预言家、女巫、猎人、守卫）、4 民。</li><li>所有玩家都记下自己的身份后，第一夜才会降临。</li><li>9 人局夜间顺序为狼人、女巫、预言家；12 人局为守卫、狼人、女巫、预言家。每个角色固定行动 20 秒，提前完成也要等到本阶段倒计时结束，超时默认不发动技能。</li><li>12 人局守卫可自守或空守，但不能连续两夜守护同一人；守卫只挡狼刀，挡不住女巫毒药。</li><li>若守卫守护目标同时被女巫使用解药，会发生“同守同救（奶穿）”，该狼刀目标仍会出局。</li><li>女巫在用药前会先看到今夜的狼刀目标；每晚最多使用一瓶药，解药和毒药各整局一次，能否自救以开局设置为准。</li><li>身份默认隐藏；按住身份区域可以查看，松开后会立即遮住。</li><li>狼人互相知道身份，并可在狼人行动阶段看到队友的实时临时票型；倒计时结束前可修改自己的投票。</li><li>好人采用屠边胜利条件：所有平民或所有神职出局后狼人获胜；狼人全部出局则好人获胜。</li><li>首夜结束先播报“天亮了”，再进行上警报名、警上发言、退水和警长投票，竞选结束后才公布首夜死讯并处理遗言。</li><li>遗言按死亡时段判定：首夜任何原因死亡的玩家都有遗言；第二夜起的夜间死亡（含女巫毒杀）没有遗言；所有白天死亡（放逐、猎人白天带走、自爆）都有遗言，9 人局普通遗言 60 秒、12 人局普通遗言 120 秒，普通狼人自爆为 30 秒自爆遗言。自爆遗言与首夜遗言是不同类型，但每个座位最多出现一次。</li><li>猎人枪杀目标与猎人按同一时段计算遗言资格；本局没有白狼王等额外角色，后续若加入特殊角色按其单独规则处理。</li><li>警长在白天放逐投票中拥有 1.5 票；出局时可以移交或撕毁警徽；退水玩家不能投警长票。</li><li>放逐首轮平票后，平票玩家先进行 PK 发言，PK 台上不能参加第二轮投票；再次平票则本日无人出局。</li><li>狼人袭击若首轮平票，按本局约定再投一轮；第二轮只能投给首轮平票目标。</li><li>白天发言与放逐投票会在相关玩家全部完成后继续，无需额外主持人。</li><li>出局玩家会在自己的界面完成离场行动；猎人可以选择开枪或放弃。</li></ol></article></div>
        </section>`.replace('</ol>', '<li>狼人可以选择狼队友作为夜间袭击目标。</li><li>存活狼人可在白天发言或警长竞选期间自爆；9 人局首次警上自爆后警徽流失，12 人局首次警上自爆将竞选顺延至下一白天，再次警上自爆则警徽流失。</li><li>首夜倒牌玩家在公布死讯前照常参加警长竞选，公布后可留遗言；后续夜间倒牌无遗言。</li></ol>');
}
