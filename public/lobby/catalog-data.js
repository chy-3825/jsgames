...
const GAME_PRESENTATION = {
    loveletter: { symbol: '✉', title: '情书', subtitle: '隐藏手牌、试探对手', english: 'LOVE LETTER', players: '2–4 人', time: '15 分钟', tone: 'rose', description: '猜中对手，成为最后留场的人。' },
    coup: { symbol: '♜', title: '政变', subtitle: '虚张声势、质疑到底', english: 'COUP', players: '2–6 人', time: '20 分钟', tone: 'violet', description: '声称角色、质疑对手，留到最后。' },
    monopoly: { symbol: '⌂', title: '环城大富翁', subtitle: '买地、交易与收租', english: 'MONOPOLY CLASSIC', players: '2–6 人', time: '以实际对局为准', tone: 'green', description: '购买地产、完成同色组并让对手破产，成为最后的赢家。' },
    ...
    avalon: { symbol: '⚔', title: '阿瓦隆', subtitle: '隐藏身份与圆桌推理', english: 'AVALON', players: '5–10 人', time: '35 分钟', tone: 'violet', description: '辨明阵营，组建队伍完成远征。' },
    scout: { symbol: '★', title: '马戏星探', subtitle: '手牌顺序与马戏表演', english: 'SCOUT', players: '2–5 人', time: '20 分钟', tone: 'rose', description: '不能重排的手牌，也能拼出最强演出。' },
    decrypto: { symbol: '⌁', title: '谍报风云', subtitle: '线索、密码与逐轮破译', english: 'DECRYPTO', players: '3–8 人', time: '30 分钟', tone: 'blue', description: '传递线索，抢先破译对手的密码。' },
    ...
    werewolf: { symbol: '狼', title: '狼人杀 · 夜幕助手', subtitle: '无主持人的昼夜推理', english: 'WEREWOLF NIGHT', players: '9 / 12 人', time: '30–60 分钟', tone: 'violet', description: '跟随夜幕指引，完成行动、发言和投票。' },
};

const GROUP_PRESENTATION = {
    'social-assist': { name: '社交推理', description: '身份、沟通与阵营博弈' },
    codebreaking: { name: '解谜与破译', description: '密码、线索与逻辑推理' },
    board: { name: '棋盘对弈', description: '落子、布局与路线竞赛' },
    tabletop: { name: '卡牌与策略', description: '经营、竞价与策略对抗' },
};
...
const GAME_COVERS = {
    ...
    avalon: '/assets/covers/avalon-v5.webp',
    decrypto: '/assets/covers/decrypto-v3.webp',
    witchtown: '/assets/covers/witchtown.webp',
    chess: '/assets/covers/chess-v6.webp',
    xiangqi: '/assets/covers/xiangqi-v5.webp',
    jungle: '/assets/covers/jungle-v3.webp',
    junqi: '/assets/covers/junqi-v14.webp',
    aeroplane: '/assets/covers/aeroplane.webp',
    gobang: '/assets/covers/gobang-v4.webp',
    checkers: '/assets/covers/checkers-v13.webp',
    monopoly: '/assets/covers/monopoly-v3.webp',
    loveletter: '/assets/covers/loveletter.webp',
    coup: '/assets/covers/coup-v2.webp',
    guessnumber: '/assets/covers/guessnumber-v2.webp',
    monopolydeal: '/assets/covers/monopolydeal.webp',
    takefive: '/assets/covers/takefive-v4.webp',
    hanabi: '/assets/covers/hanabi.webp',
    splendor: '/assets/covers/splendor-v3.webp',
    kingdomino: '/assets/covers/kingdomino-v2.webp',
    acquire: '/assets/covers/acquire.webp',
    citadels: '/assets/covers/citadels-v2.webp',
    ...
    camelup: '/assets/covers/camelup-v2.webp',
